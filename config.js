...
const presentationConfig = {
  ...
  sections: [
    ...
    { name: "The Bridge", startSlide: 8 },
    { name: "BidRight", startSlide: 9 },
    { name: "BidRight Story", startSlide: 10 },
    { name: "How It Works", startSlide: 14 },
    { name: "Next Steps", startSlide: 21 },
    { name: "Connect", startSlide: 22 }
  ]
};
